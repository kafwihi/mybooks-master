...
public class SalesAdapter extends BaseAdapter {
    ...
    public SalesAdapter(Context context,ArrayList<String> item,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
            convertView =layoutInflater.inflate(R.layout.sales_layout,null);
        SalesAdapter.viewHolder holder = new SalesAdapter.viewHolder();
