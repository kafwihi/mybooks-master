...
public class AllSalesAdapter extends BaseAdapter {
    ...
    public AllSalesAdapter(Context context,ArrayList<String> date,ArrayList<String> item,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
            convertView =layoutInflater.inflate(R.layout.all_sales_layout,null);
        AllSalesAdapter.viewHolder holder = new AllSalesAdapter.viewHolder();
